            ...
            <div class="col-md-3">
                <div class="card">
                    ...
                    <div class="card-body text-end">
                        ...
                        <button @click="deleteAccount" class="btn btn-danger mt-2">Leave</button>
                    </div>
                </div>
            </div>
            <div class="col-md-4 mt-3 text-end">
                ...
                <form @submit.prevent="updateProfileUI">
                    <div class="mb-3  text-start">
                        <label for="newNickName" class="form-label">New Name</label>
                        <input type="text" class="form-control" id="newNickName" v-model="newNickName">
                    </div>
                    <div class="mb-3 text-start">
                        <label for="newProfileImageFile" class="form-label">New Profile Image</label>
